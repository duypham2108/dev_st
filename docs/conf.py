...
sys.path.insert(0, os.path.abspath('../stlearn/tools/cci'))
...
#   url = "https://www.dropbox.com/s/d5dz5b63gpoquu2/downloads.zip"
#   os.system("wget " + url)
...
latex_documents = [
    (master_doc, 'stlearn.tex',
     'stLearn Documentation',
     'Genomics and Machine Learning lab', 'manual'),
]
